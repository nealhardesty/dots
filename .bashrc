...
alias walrus="rdesktop -m -z -g 1280x1024 -P -u neal localhost -p PASSWORD 2> /dev/null "
#alias otter="rdesktop -m -z -g 1280x1024 -P -u neal localhost:3390 -p PASSWORD 2> /dev/null "
alias moose="rdesktop -m -z -g 1280x1024 -P -u neal localhost:3390 -p PASSWORD 2> /dev/null "
#alias otterwinvnc="vncviewer -encodings Tight -quality 0 localhost:5901"
#alias otterwin="rdesktop -m -z -g 1280x1024 -P -u neal localhost:3391 -p PASSWORD 2> /dev/null "
#alias otter="vncviewer -encodings Tight -p ~/pass.txt -quality 4 localhost:5900"
